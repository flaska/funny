    ...
    render(){
        return (
            <div style={styles.main}>
                <InfoChip icon='md_thumb_up'>{formatNumber(this.props.postData.score)}</InfoChip>
                <div style={styles.div} className='feedItemMetadata_comments' onClick={()=>{this.props.onCommentsClick()}}>
